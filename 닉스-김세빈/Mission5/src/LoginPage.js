      ...
      <section class="Second_part">
        <div class="Second_part_1">
          ...
          <ul class="Second_part_2">
            ...
            <li>
              <a href="https://www.kurly.com/collections/market-best">베스트</a>
            </li>
            <li>
            ...
            <li>
              <a href="https://www.kurly.com/market-benefit">특가/혜택</a>
            </li>
          </ul>
        </div>
      </section>
      <section>
        <div class="Log-in_part">
          <h1>로그인</h1>
          <input class="input_id" placeholder="아이디를 입력해주세요" />
          <br />
          <input class="input_pw" placeholder="비밀번호를 입력해주세요" />
          <br />
          ...
          <div class="Btn_bottom">
            ...
            <br />
            <button class="Newacc_Btn">회원 가입</button>
          </div>
        </div>
      </section>
